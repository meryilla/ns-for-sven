...
class CMarineSentry : ScriptBaseMonsterEntity, NS_BASE_TURRET::TurretBase
{
    ...
    void Precache()
    {
        ...
        g_SoundSystem.PrecacheSound( SOUND_FIRE1 );
        g_SoundSystem.PrecacheSound( SOUND_FIRE2 );
        g_SoundSystem.PrecacheSound( SOUND_FIRE3 );
        g_SoundSystem.PrecacheSound( SOUND_FIRE4 );
        g_SoundSystem.PrecacheSound( SOUND_DEPLOY );
        g_SoundSystem.PrecacheSound( SOUND_PING );
        g_SoundSystem.PrecacheSound( SOUND_DEATH1 );
        g_SoundSystem.PrecacheSound( SOUND_DEATH2 );
        g_SoundSystem.PrecacheSound( SOUND_DEATH3 );
    }
